...
import com.androiddevs.mvvmnewsapp.app.util.Constants.Companion.QUERY_PAGE_SIZE
            ...
            when(response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        val totalPages = newsResponse.totalResults / QUERY_PAGE_SIZE +2 //+1 because the integer division will round off and +1 because the last page is empty
